...
export const badgeStyling: IBadgeStyling = {
  ...
  'outline-blue': {
    ...
    hover:
      'hover:text-blue-600/95 hover:border-opacity-85 [data-state=checked]:text-blue-600/95 [&>svg]:stroke-blue-600/95'
  },
  'outline-indigo': {
    default: 'text-indigo-600 border border-indigo-600 [&>svg]:stroke-indigo-600',
    hover:
      'hover:text-indigo-600/95 hover:border-opacity-85 [data-state=checked]:text-indigo-600/95 [&>svg]:stroke-indigo-600/95'
  },
  'outline-purple': {
    default: 'text-purple-600 border border-purple-600 [&>svg]:stroke-purple-600',
    hover:
      'hover:text-purple-600/95 hover:border-opacity-85 [data-state=checked]:text-purple-600/95 [&>svg]:stroke-purple-600/95'
  },
  'outline-pink': {
    default: 'text-pink-600 border border-pink-600 [&>svg]:stroke-pink-600',
    hover:
      'hover:text-pink-600/95 hover:border-opacity-85 [data-state=checked]:text-pink-600/95 [&>svg]:stroke-pink-600/95'
  },
  'outline-rose': {
    default: 'text-rose-600 border border-rose-600 [&>svg]:stroke-rose-600',
    hover:
      'hover:text-rose-600/95 hover:border-opacity-85 [data-state=checked]:text-rose-600/95 [&>svg]:stroke-rose-600/95'
  },
  'outline-orange': {
    default: 'text-orange-500 border border-orange-500 [&>svg]:stroke-orange-500',
    hover:
      'hover:text-orange-500/95 hover:border-opacity-85 [data-state=checked]:text-orange-500/95 [&>svg]:stroke-orange-500/95'
  },
  'outline-yellow': {
    default: 'text-yellow-500 border border-yellow-500 [&>svg]:stroke-yellow-500',
    hover:
      'hover:text-yellow-500/95 hover:border-opacity-85 [data-state=checked]:text-yellow-500/95 [&>svg]:stroke-yellow-500/95'
  },
  'outline-green': {
    default: 'text-green-600 border border-green-600 [&>svg]:stroke-green-600',
    hover:
      'hover:text-green-600/95 hover:border-opacity-85 [data-state=checked]:text-green-600/95 [&>svg]:stroke-green-600/95'
  },
  'outline-teal': {
    default: 'text-teal-600 border border-teal-600 [&>svg]:stroke-teal-600',
    hover:
      'hover:text-teal-600/95 hover:border-opacity-85 [data-state=checked]:text-teal-600/95 [&>svg]:stroke-teal-600/95'
  },
  'outline-cyan': {
    default: 'text-cyan-600 border border-cyan-600 [&>svg]:stroke-cyan-600',
    hover:
      'hover:text-cyan-600/95 hover:border-opacity-85 [data-state=checked]:text-cyan-600/95 [&>svg]:stroke-cyan-600/95'
  }
};
