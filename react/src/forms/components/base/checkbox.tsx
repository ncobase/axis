...
>(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ref={ref}
    className={cn(
      'w-3.5 h-3.5 shrink-0 rounded-sm border border-gray-300 text-primary-600',
      'shadow-[0.03125rem_0.03125rem_0.125rem_0_rgba(0,0,0,0.03)] hover:border-gray-400/65',
      ...
      'disabled:[&+label]:cursor-not-allowed disabled:[&+label]:opacity-55',
