...
>(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ref={ref}
    className={cn(
      'h-[0.9375rem] w-[0.9375rem] shrink-0 rounded-sm border-[0.0625rem] border-gray-400 text-primary-600 shadow-[0.03125rem_0.03125rem_0.125rem_0_rgba(0,0,0,0.03)] hover:border-gray-400/65',
